...
class CalculatorView(tk.Tk):
    ...
    def init_component(self):
        ...
        self.input_button = tk.Button(self, bg='DarkSeaGreen1', text='Recall Input', command=self.controller.recall_input)
        self.input_button.pack(side=tk.TOP, expand=True, fill=tk.BOTH)

        self.result_button = tk.Button(self, bg='DarkSlateGray1', text='Recall Result', command=self.controller.recall_result)
